    ...
    <div class="max-w-5xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div class="md:col-span-1">
                ...
                @if($book->copertina)
                    <div class="bg-gray-100 rounded-xl shadow-sm border p-4 flex items-center justify-center">
                        <img src="{{ asset('storage/' . $book->copertina) }}" class="max-w-full h-auto object-contain"
                            alt="{{ $book->titolo }}">
                    </div>
                @else
