...
@section('content')
    ...
    <div class="max-w-5xl mx-auto">
        ...
        <!-- HEADER -->
        <div class="mb-8">
            <h1 class="text-3xl font-bold">Nuovo autore</h1>
            <p class="text-gray-500">Inserisci le informazioni dell’autore</p>
        </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="space-y-6">
                    ...
                    <div class="border rounded-lg p-4">
                        ...
                        <input type="text" name="nazione" class="w-full mt-2 border-b border-gray-300 py-2">
                    </div>

                    <!-- Data -->
                    <div class="border rounded-lg p-4">
                        <label class="text-sm text-gray-500">Data di nascita</label>
                        <input type="date" name="data_di_nascita" class="w-full mt-2 border rounded px-2 py-1">
                    </div>
